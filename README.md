...
```sh
 ...
 git clone https://github.com/alyconr/port-projetcsV2
```
...
```sh
  cd my-folder
  git clone git@github.com:myaccount/port-projetcsV2
```
...
Feel free to check the [issues page](https://github.com/alyconr/port-projetcsV2/issues).
